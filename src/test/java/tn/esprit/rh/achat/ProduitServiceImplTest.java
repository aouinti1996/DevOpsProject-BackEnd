...
class ProduitServiceImplTest {
    ...
    Produit produit = new Produit( " 12345", "houssem",(float)7.4,new Date(),new Date());
    List<Produit> listProduit = new ArrayList<Produit>(){
        {
            add(new Produit("123456", "houssem1",(float)7.4,new Date(),new Date()));
            add(new Produit("1234567", "houssem2",(float)8.4,new Date(),new Date()));
        }
    };
    @Test
    ...
    void testAssignProduitToStock() {
        ...
        Produit p = new Produit(" 12345", "houssemeddine",(float)7.4,new Date(),new Date());
